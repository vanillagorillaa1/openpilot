...
STATIC_MSGS = [
  ...
  (0x367, ECU.CAM, (CAR.AVALON), 0,  40, '\x00\x00'),
  ...
  (0x128, ECU.DSU, (CAR.AVALON), 1,  3, '\xfc\x3f\x00\x00\x00\x6a'),
  ...
  (0x160, ECU.DSU, (CAR.AVALON), 1,   7, '\x00\x00\x08\x12\x09\x31\x9c\x59'),
  (0x161, ECU.DSU, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.RAV4, CAR.COROLLA), 1,   7, '\x00\x1e\x00\x00\x00\x80\x07'),
  (0x161, ECU.DSU, (CAR.AVALON), 1,   7, '\x00\x1e\x00\x38\x00\x00\xbf'),
  ...
  (0x366, ECU.DSU, (CAR.AVALON), 0,  20, '\x0d\xd2\x07\xff\x0f\xba\x00'),
  (0x470, ECU.DSU, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH), 1, 100, '\x00\x00\x02\x7a'),
  (0x470, ECU.DSU, (CAR.HIGHLANDER, CAR.HIGHLANDERH, CAR.AVALON), 1,  100, '\x00\x00\x01\x79'),
